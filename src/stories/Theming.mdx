...
| Resource | Modo | Broadcast runtime |
|---|---|---|
| `mri_Qmultichar` | NUI persistente | ✅ |
| `mri_Qspawn` | NUI persistente | ✅ |
| `mri_Qadmin` | **Controlador** + NUI persistente | ✅ |
| `mri_Qloadscreen` | NUI efêmera (handshake) | ❌ (re-le no handover) |
